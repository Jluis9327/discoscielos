            ...
            <form class="form-horizontal" method="POST" action="<?php echo e(url('/recep/register')); ?>" enctype="multipart/form-data">
                ...
                <div class="form-group<?php echo e($errors->has('DNI') ? ' has-error' : ''); ?>">
                    <center><div class="col-md-4">
                            <input id="dni" type="text" class="form-control" name="DNIx" placeholder="DNI" style="text-align: center; background-color: transparent; color: white" value="<?php echo e($id); ?>" maxlength="8" onkeypress="return validaNumericos(event)" required autofocus disabled>
                            <input type="hidden" name="DNI" value="<?php echo e($id); ?>">
                ...
                <div class="form-group<?php echo e($errors->has('password') ? ' has-error' : ''); ?>">
                    <center><div class="col-md-4">
                            <input id="password" type="password" class="form-control" name="passwordx" placeholder="Contraseña" style="text-align: center; background-color: transparent; color: white" value="<?php echo e($id); ?>" onkeypress="validaNumericos(event)" required disabled>
                            <input type="hidden" name="password" value="<?php echo e($id); ?>">
