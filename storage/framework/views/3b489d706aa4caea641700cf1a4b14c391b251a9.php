<?php $__env->startSection('content'); ?>
    <section id="testimonials" class="section-bg wow ">
        <div class="container">
                        ...
                        <select class="form-control" id="xs" onchange="javascript:handleSelect(this)">
                            ...
                            <?php for($i = 2; $i>=0 ; $i--): ?>
                                <?php if($presentation[$i]->Date==$date): ?>
                                    <option value="<?php echo e(url('/client/zone/secondlevel/'.$dni.'/day/'.$presentation[$i]->Date)); ?>" <?php echo e("selected"); ?>><?php echo e($presentation[$i]->Date); ?></option>
                                <?php else: ?>
                                    <option value="<?php echo e(url('/client/zone/secondlevel/'.$dni.'/day/'.$presentation[$i]->Date)); ?>"><?php echo e($presentation[$i]->Date); ?></option>
                                <?php endif; ?>
                            <?php endfor; ?>
                        </select>
                    </div>
                </div>
                <form id="formulario" action="<?php echo e(url('/client/zone/secondlevel/'.$dni.'/day/'.$date)); ?>" method="POST" enctype="multipart/form-data">
            ...
            <center><a href="<?php echo e(url('/client/zone/'.$dni)); ?>"><i class="ion-ios-undo-outline" style="font-size: 350%"></i></a>
