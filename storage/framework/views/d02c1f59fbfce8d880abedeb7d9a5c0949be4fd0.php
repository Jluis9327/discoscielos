<?php $__env->startSection('content'); ?>
    <section id="testimonials" class="section-bg wow ">
        <div class="container">
            ...
            <center>
                <a href="<?php echo e(url('/recep/firstlevel/'.$dni)); ?>"><img src="<?php echo e(asset('img/primernivel.jpg')); ?>"></a>
                <a href="<?php echo e(url('/recep/secondlevel/'.$dni)); ?>"><img src="<?php echo e(asset('/img/segundonivel.jpg')); ?>"></a>
            </center>
            <br>
