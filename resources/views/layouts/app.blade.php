...
<head>
    ...
    <link href="{{asset('lib/lightbox/css/lightbox.min.css')}}" rel="stylesheet" type="text/css">
...
<header id="header">
    <div class="container-fluid">
        ...
        <div id="logo" class="pull-left">
            <h1><a href="{{url('/')}}" class="scrollto"><img src="{{asset('img/cieloslogo.png')}}"></a></h1>
        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 footer-info">
                    <h3><img src="{{asset('img/cieloslogo.png')}}"></h3>
...
<script src="{{asset('lib/superfish/hoverIntent.js')}}" type="text/javascript"></script>
<script src="{{asset('lib/superfish/superfish.min.js')}}" type="text/javascript"></script>
